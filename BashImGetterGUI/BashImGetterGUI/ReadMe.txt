...
BashImGetterGUI.h
    ...
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CBiGGUIApp.

BashImGetterGUI.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CBiGGUIApp.
...
BiGGUIDlg.h, BiGGUIDlg.cpp — диалоговое окно
    Эти файлы содержат класс CBiGrGUIDlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле BashImGetterGUI.rc, который можно изменять с помощью Microsoft Visual C++.
